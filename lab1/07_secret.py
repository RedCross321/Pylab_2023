...
secret_message = [
    ...
    'дьсеы6лцвбане4т64ь4б3ущея6втщл6б',
...
print(secret_message[0][3], secret_message[1][9:13], secret_message[2][5:14:2], secret_message[3][-20:6:-1], secret_message[4][-12:15:-1])