...
def apartment():
    ...
    def schet():
        ...
        lab11 = Label(text=f'Площадь помещения: {x} м^2\n Тепловая мощность для обогрева: {y} кВт',width=550,bg='white', fg='black', wraplength=550, font=("Bahnschrift", 14),justify=LEFT)
        canvas.create_window(0, 0, anchor=NW, window=lab11, width=400, height=0)
...
but1 = Button(text="Комната", width=20, command=apartment)
but2 = Button(text="Квартира", width=20, command=go_main)
